...
const app = new Vue({
  ...
  methods: {
    ...
    getFontSize() {
      return this.select.class === 'ZONE_REMOVAL' ? '18' : '18';
    },
    ...
    categorizeTattoos(data) {
      ...
      this.tattoos.ZONE_ARM = [];
      this.tattoos.ZONE_LEG = [];
      data.forEach(tattoo => {
        switch (tattoo.Zone) {
          case 'ZONE_HEAD':
          ...
          case 'ZONE_TORSO':
            ...
            break;
          case 'ZONE_ARM':
            this.tattoos.ZONE_ARM.push(tattoo);
            break;
          case 'ZONE_LEG':
            this.tattoos.ZONE_LEG.push(tattoo);
            break;
          default:
            break;
        }
